# MyWebnote - 一款以图形为中心的思维管理工具
[English](README.md)

MyWebnote 正处于公测阶段，功能还有不少不足或者缺陷。如果你有任何问题或者建议，欢迎提交 [issue](https://github.com/wl4g-collect/mywebnote/issues/new) 进行反馈。
...
## 给个 Star
如果 MyWebnote 对你有帮助，请不要吝惜小手给个 Star ⭐ 吧 ☝️ 

## 使用 MyWebnote
* 线上体验版本（数据存储在浏览器）: https://mywebnote.com
* 桌面应用版本（数据存储在电脑端）: https://github.com/wl4g-collect/mywebnote/releases

## 反馈问题
MyWebnote 正处于公测阶段，功能还有不少不足或者缺陷。如果你有任何问题或者建议，欢迎提交 [issue](https://github.com/wl4g-collect/mywebnote/issues/new) 进行反馈。

## 参与公测
目前 MyWebnote 已正式开放公测。如果大家在产品使用过程中有任何问题或者产品上的想法，欢迎参与公测反馈问题或建议，您的建议将直接影响未来产品迭代的方向和节奏。让我们一起打造一个用起来爽的思维管理工具。
...
### Excalidraw 白板
你可以在 MyWebnote 中以更简单的姿势使用 Excalidraw 功能，可以在桌面应用中自定义字体，也可以通过双链功能有效连接 MyWebnote 中的笔记。
![](https://img.alicdn.com/imgextra/i4/O1CN01TPddti1nbyNkT9Qkc_!!6000000005109-2-tps-2952-1706.png)

#### 在 Excalidraw 白板中自定义字体
MyWebnote 的画布支持用户自定义字体，不过目前只有桌面端应用支持画布自定义字体。
...
### Tldraw 白板
MyWebnote 新增 Tldraw 白板功能，给大家更多不一样的白板体验。
![](https://img.alicdn.com/imgextra/i3/O1CN01bB91Wp20SR8j33SvQ_!!6000000006848-2-tps-2952-1706.png)

### 笔记
MyWebnote 中的笔记是一个所见即所得的类 Notion 编辑器，支持 '/' 命令和 Markdown 语法。
...
## 关于仓库
该仓库只包含 MyWebnote 基础功能代码，和 mywebnote.com 和 MyWebnote 桌面应用提供的能力并不完全同步。
