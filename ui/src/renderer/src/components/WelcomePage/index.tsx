...
function WelcomeContent() {
  ...
  return (
    <div className="mywebnote-welcome-page w-full h-full flex pt-10 pb-10 justify-center text-slate-400">
      <div className="content w-2/3 overflow-scroll">
        <div className="flex items-center mb-6">
          <MyWebnoteLogo size="large" url="https://mywebnote.com" />
          <span className="text-xl"> - {t('text.beta')}</span>
        </div>
        ...
        <p className="mb-6 text-sm flex items-center">
          {!isInMyWebnoteApp ? t('welcome.onlineTry') : null} {t('welcome.downloadApp')}{' '}
        ...
        <div>
          ...
          <p className="mb-2">
            <a href="https://github.com/wl4g-collect/mywebnote" target="_blank" rel="noreferrer">
